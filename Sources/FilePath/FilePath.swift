...
public enum N_FilePath {
    ...
    public var filePath: String {
        ...
        case .download: return NSSearchPathForDirectoriesInDomains(.downloadsDirectory, .userDomainMask, true)[0]
